>Basé sur les règles de [DnD 5e - Appendix A]([https://www.dndbeyond.com/sources/dnd/basic-rules-2014/combat](https://www.dndbeyond.com/sources/dnd/basic-rules-2014/appendix-a-conditions)
...
- La condition prend fin si l'attrapeur est [[Conditions#Incapable|incapacité]].
...
- Une créature paralysée est [[Conditions#Incapable|incapacité]] et ne peut ni bouger ni parler.
...
- La créature est [[Conditions#Incapable|incapacité]], ne peut ni bouger ni parler et n'est pas conscient de son environnement.
...
- Une créature étourdie est [[Conditions#Incapable|incapacité]], ne peut pas bouger et ne peut parler que de manière hésitante.
- La créature échoue automatiquement aux jets de sauvegarde de Force et de Dextérité.
- Les jets d'attaque contre la créature ont un avantage.

## Inconscient

- Une créature inconsciente est [[Conditions#Incapable|incapacité]], ne peut ni bouger ni parler et n'est pas conscient de son environnement.
- La créature laisse tomber tout ce qu'elle tient et tombe [[Conditions#Couché|couché]].
- La créature échoue automatiquement aux jets de sauvegarde de Force et de Dextérité.
- Les jets d'attaque contre la créature ont un avantage.
- Toute attaque qui frappe la créature est un coup critique si l'attaquant se trouve à moins de 5 pieds de la créature.

## Saignement
La cible perd Xd4 HP par tour jusqu'à être soignée.
...
## Poison
La cible prend 1d6 HP par tour pendant 3 tours ou jusqu'à être soigné.
