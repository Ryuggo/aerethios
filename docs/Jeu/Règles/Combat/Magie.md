...
## Défensif/ Soutien
>Regroupe tous les sorts affectant les statistiques et les conditions (saignement, poison, ..).

### Améliorer une statistique
Le joueur jette ses dés de magie et augmente une statistique de son choix de 1 tous les 10 points qu'il fait pour une durée de 1 jour ou le temps d'un combat.

### Soigner une condition

### Immuniser contre une condition
